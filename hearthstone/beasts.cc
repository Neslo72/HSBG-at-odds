...
void standard_death(Board *ally, Board *enemy, Minion* self, char death_idx, Minion *attacker)
{
    // ally->remove_minion(self);
    // do nothing
}
...
// STANDARD DEATH should be used for minions without a specific deathrattle
